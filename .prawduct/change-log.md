...
- **Maintenance** is committed without asking and named in the commit body. It is a tracked file whose change is provably TangleClaw's:
  ...
  - `.claude/settings.json` (named by `engines.SHARED_HOOK_SETTINGS_PATHS`), changed only in TangleClaw hook entries;
