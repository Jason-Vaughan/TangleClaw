...
- **Roles:** the micro filter and reconstruction move from the Builder to a dedicated PR Reviewer working in a non-serving worktree. The Coordinator drafts all contributor replies, from the recorded findings of the filter that reached the verdict. There is a Code Reviewer step, with the interim substitute being the Critic plus the operator's review, and no auto-merge on reconstructions.
