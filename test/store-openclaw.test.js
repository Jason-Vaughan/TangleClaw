  ...
  describe('schema migration', () => {
    ...
    it('v14→v15 migration preserves existing bridge_port row data verbatim (#160)', () => {
      ...
      try {
        ...
        // Schema version advanced to current (v14 → v15 bridge_port rebuild → v16 instance_dir → v17 migration_status → v18 session_rules → v19 session_rule_versions → v20 session_rules.kind → v21 sessions.owner → v22 projects.orchestration_profile).
