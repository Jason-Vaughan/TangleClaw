...
const { execShell, execFileArgs, NO_PROMPT_ENV } = require('../lib/exec');
...
describe('lib/exec — shared runner (#1561)', () => {
  ...
  describe('callers', () => {
    ...
    it('the background update check runs git with prompts disabled', () => {
      const opts = require('../lib/update-checker')._lsRemoteOptions();
