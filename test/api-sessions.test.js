  ...
  describe('POST /api/sessions/:project/wrap response (#139 Chunk 10)', () => {
    it('threads options from body to runWrapPipeline and surfaces pipelineResult', async () => {
      ...
      try {
        ...
        const { onStepEvent, resumeFrom, wrapRunId, admitStep, isCancelRequested, controlGate, keepSessionRunning, keepSource, ...userOptions } = receivedOptions;
        ...
        assert.equal(typeof controlGate, 'function', '#1861 control gate threaded to the runner');
