...
// existing installs.
const CACHE_NAME = 'tangleclaw-v3-12';
const STATIC_ASSETS = [
  '/',
  '/style.css',
  '/landing.js',
...
// #246 — Files in this set get network-first treatment, same as
// API/navigation. Reserved for scripts whose ENTIRE PURPOSE is cache
// invalidation: serving a stale copy from the SW cache is by
// definition wrong, since the operator just shipped a new version
// precisely because the old one had a cache-related bug. Keep this set
// small and audited — every entry pays the latency cost of a network
