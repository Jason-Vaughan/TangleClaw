    ...
    <div class="form-group">
      ...
      <div class="form-hint">
        ${state.restartMechanism
          ...
          : 'Disabled: no restart mechanism detected on this host (needs the macOS launchd plist, or a systemd user unit at ~/.config/systemd/user/tangleclaw.service on Linux).'}
      </div>
    </div>
  `;
