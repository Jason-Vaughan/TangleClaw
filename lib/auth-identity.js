 ...
 *   armed for this request (`lib/auth-gate.js#resolveGateState` answered
 *   `armed`). Defaults to false so every existing caller keeps its answer.
...
function resolveAuthStatus(headers, config, tcGateActive) {
  ...
  // `auth-gate.js#resolveGateState` asks authEnabled AND an enabled account. Both
