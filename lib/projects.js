 ...
 * @returns {{stranded: {total: number, unacknowledged: number, grandfathered: number, blocking: number}|null,
 *   strandedError: string|null}}
 */
function strandedSummary(project) {
  try {
    return { stranded: strandedWraps.counts(strandedWraps.list(project).items), strandedError: null };
