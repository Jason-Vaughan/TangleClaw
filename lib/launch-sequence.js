 ...
 */
function buildSnapshot({ launchId, project, engineProfile, applicability, rendered, rules, preflight = PREFLIGHT_NOT_EVALUATED, recoveryMode = 'operator', renderContext = null }) {
