 ...
 *
 * NOTE: no runtime caller remains — the prime stopped inlining curated text and
 * now uses `countCuratedEntries` / `countTodoEntries` for its census. Only this
 * module's own tests exercise it. Remove-vs-keep is tracked as PRM-4H8N; it is
 * left in place rather than deleted mid-chunk so the decision is made
 * deliberately instead of as a side effect of unrelated work.
 *
