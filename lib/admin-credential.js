 ...
 *   connection. Defaults to true for non-request callers (the CLI has no socket).
 ...
 */
function canChangeCredential(config, ingressState, caddyAvailable = true, fromLoopback = true) {
