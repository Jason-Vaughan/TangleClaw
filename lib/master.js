...
function buildMasterClaudeMd(config, extras = {}) {
  ...
  lines.push(
    ...
    `- \`GET /api/awareness\` — per-session awareness state (confirmed/sent/unverified/no-rules/unaware); an 'unaware' recent session means that project's sessions may not know TangleClaw exists.`,
