 ...
 * group's `/sync` (documented as a shared-docs operation). The rest of
 * `/api/groups*` is outside this token gate; who may call it is decided by the
 * caller binding in `lib/shared-docs-access.js`, not by this token.
 *
