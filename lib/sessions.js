...
function generatePrimePrompt(project, engineProfile, options = {}) {
  ...
  // engine gets it. `primeLines` renders nothing for passing and for a
  // project with no origin or no workflow runs.
  sections.push(...ciStatus.primeLines(ciStatus.probeMainCi(project.path)));
