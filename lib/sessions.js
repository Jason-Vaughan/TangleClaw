 ...
 * - The Master pane is deliberately not wrapped: it gets no ambient identity
 *   env by design (read-only posture, no project), and a PATH-reachable `tc`
 *   there would report "not launched under TangleClaw" — a lie in that pane.
 *
