...
function launchSession(projectName, options = {}) {
  ...
  // is not an error, but it is not nothing: this session gets none of the
  // project's rules and none of TangleClaw's guides, and nothing used to say
  // so anywhere (#1251).
  ...
  engines.reportMissingConfigCarrier(writeResult, projConfig, engineProfile,
    { project: project.name, engine: engineId, at: 'launch' });
