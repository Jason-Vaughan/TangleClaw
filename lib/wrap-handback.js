 ...
 *   - `quiet`, `completedVia: 'quiet'` — the terminal stopped changing for the
 *     content step's quiet window with no line. Not `ready`: a session handed a
 *     fix often stops to ask the operator something, and silence cannot tell
 *     that from finished. `completionNote` says what was seen;
