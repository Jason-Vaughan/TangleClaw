 ...
 *
 * `lib/checkout-state.js`, `lib/behind-origin.js` and `lib/upstream-observer.js`
 * all ask git small questions from inside the server process, and each needs
 * the same four guarantees. Kept here so a fix to one of them reaches all:
 *
