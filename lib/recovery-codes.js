 ...
 *
 * The last entry is taken, because a proxy appends the peer it saw.
 *
...
function clientKey(socket, headers, isLoopback) {
  ...
  const xff = headers && typeof headers['x-forwarded-for'] === 'string' ? headers['x-forwarded-for'] : null;
  if (xff !== null && isLoopback(addr)) {
