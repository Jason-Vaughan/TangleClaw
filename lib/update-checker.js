 ...
 * @returns {{ updateAvailable: boolean, currentVersion: string|null, latestVersion: string|null, releaseUrl: string|null, repoRoot: string, checkedAt: string }}
 */
function checkForUpdate() {
  ...
  if (!currentVersion) {
    ...
    _cache = { updateAvailable: false, currentVersion: null, latestVersion: null, releaseUrl: null, repoRoot: _repoRoot, checkedAt };
    return _cache;
  }
  ...
  try {
    ...
    if (!latestTag) {
      ...
      _cache = { updateAvailable: false, currentVersion, latestVersion: null, releaseUrl: null, repoRoot: _repoRoot, checkedAt };
      return _cache;
    }
    ...
    _cache = { updateAvailable, currentVersion, latestVersion, releaseUrl, repoRoot: _repoRoot, checkedAt };
 ...
 * @returns {{ updateAvailable: boolean, currentVersion: string|null, latestVersion: string|null, releaseUrl: string|null, repoRoot: string, checkedAt: string|null }}
 */
