...
const STARTUP_FIRE_REASON_CODES = Object.freeze([
  'engine_declares_none', 'profile_block_malformed', 'adapter_not_registered',
  'dispatch_unavailable', 'fire_scope_denied'
]);
...
function _createTables() {
  _db.exec(`
    ...
    -- may be retried is the adapter chunk's explicit decision.
