...
function _runMigrations() {
  ...
  if (currentVersion < CURRENT_SCHEMA_VERSION) {
    ...
    // row down for a version already stamped. When a later migration raises
    // CURRENT past 42 this still stamps it, outside that transaction, which is
    // correct: v42 really is complete by then.
