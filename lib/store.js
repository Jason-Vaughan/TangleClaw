...
const awarenessReceiptsApi = {
   ...
   *   - `unaware`    — no receipt and no delivered/unverified row. Precisely:
   *                    no EVIDENCE awareness arrived — the state that hid for
   *                    12 days in August 2026 and must not be able to again.
   *
