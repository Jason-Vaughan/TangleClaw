...
// vocabulary: the CHECK constraint, the lease validator, the HTTP route and the
// Caddyfile divergence check all read this array, so widening it is a
// single-line change that cannot leave one surface behind. Order is widening —
// index 0 is the weakest claim and the default.
