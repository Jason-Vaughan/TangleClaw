 ...
 *
 * **Retention.** A file is deleted `RETAIN_MS` after its attempt ended. That
 * default is the Architect's recommendation; the retention period is the
 * operator's decision (Car A3 Chunk 03 plan).
 */
