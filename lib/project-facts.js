 ...
 *
 * `git.getInfo` still dominates by an order of magnitude — the version chain
 * reads small files at the project root — so the additions since this was last
 * sized do not move the figure.
 *
