...
const ENGINE_WAKE_PROFILES = {
  ...
  antigravity: {
    ...
    //
    // The landed shape was re-measured on 1.1.24 while building this: a taken
    // submission echoes the text into the transcript and returns the composer
    // to a bare `>`; typing alone already moves the pane digest, which is why
    // digest movement is not the signal.
    observePaste: true
  }
};
