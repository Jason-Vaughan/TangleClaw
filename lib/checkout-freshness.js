...
function projectCheckout(project, options = {}) {
  ...
  const { ahead, behind, relation, upstream: localUpstream, ...own } = cs;
  const block = {
    ...own,
    localRef: { ref: localUpstream ? localUpstream.ref : null, sha: localUpstream ? localUpstream.sha : null, ahead, behind, relation },
    upstream,
