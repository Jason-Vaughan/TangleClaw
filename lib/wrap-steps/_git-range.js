 ...
 * argv runner takes the array directly. Every value interpolated here is either a
 * literal from `PROBES` or a SHA already matched against `SHA_RE`, so nothing
 * unvalidated reaches a shell.
 *
