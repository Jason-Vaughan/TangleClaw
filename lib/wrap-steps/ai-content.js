...
function _verifyChangedGate(projectPath, step, beforeSnapshot) {
  ...
  return {
    ...
    remediation: `The AI reported done but did not modify ${names}. If there is genuinely nothing to record this session, tick "Skip & note" to wrap without this step. Otherwise wait for the AI to finish the edit and click Retry.`
  };
}
