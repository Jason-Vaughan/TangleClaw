...
module.exports = { run, stagedFromOutput, _internal, _interpolatePrompt, _readOnlyModeMarker, _readOnlyPrecheck, _readOnlyRemediation, _withPrecheck, _runTmuxCapture, READ_ONLY_TAIL_LINES, _appendWrapRules, _wrapStepHeader, _parseFields, _resolveCaptureContract, _hasCaptureContract, _uncapturedOptional, _normalizeFieldKey, _runGatewayCapture, _resolveEngineConfigFile, _snapshotPaths, _watchedOutputPaths, _verifyChangedGate, SUPPORTED_PROMPT_TOKENS, STABILITY_MS, QUIET_FALLBACK_MS, MAX_WAIT_MS, POLL_INTERVAL_MS, PANE_TAIL_LINES, MARKER_GRACE_MS, _markerSeen, _completionInstruction, SATISFACTION_PREDICATES };
