 ...
 * absence never blocks. The two lists are unioned before parsing
...
module.exports = { run, _internal, _interpolatePrompt, _readOnlyModeMarker, _readOnlyPrecheck, _readOnlyRemediation, _withPrecheck, _runTmuxCapture, READ_ONLY_TAIL_LINES, _appendWrapRules, _wrapStepHeader, _parseFields, _resolveCaptureContract, _normalizeFieldKey, _runGatewayCapture, _resolveEngineConfigFile, _snapshotPaths, _watchedOutputPaths, _verifyChangedGate, SUPPORTED_PROMPT_TOKENS, STABILITY_MS };
