 ...
 */
/**
 * Bound a raw subprocess error before it is persisted. Mirrors the 200-char
 * cap `pr-merge.js` `_ensurePushed` applies to the same class of text.
 *
 * @param {string|null} text - Raw `git`/`gh` stderr, or null
 * @returns {string|null} The text, truncated with an ellipsis, or null
 */
