 ...
 *
 * Non-throwing: an unreadable config yields null, which reads downstream as "no
 * boundary recorded" rather than as a boundary that failed to load.
 *
 * @param {string} projectPath
 * @returns {string|null} The recorded base, or null when none is recorded or the
