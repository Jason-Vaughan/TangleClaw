...
async function run(context) {
  ...
  // #1512 — an approved un-track offer, resolved on the same inputs `session-files`
  // asked on, so the paths removed are exactly the paths the operator was shown.
  const untrackPaths = await _approvedUntrackPaths(context, scope);
