...
function _truncateForRecord(text) {
  ...
  // would miss the most likely credential of all. Matching the whole userinfo
  // cannot over-match: a credential-free URL has no `@` before its first `/`,
  // and userinfo cannot contain `/`, whitespace or a second `@`, which keeps
  // this from eating the rest of the line.
