 ...
 * config (`.tangleclaw/project.json`, including the `lastWrapSha` boundary) is
 * gitignored machine state that exists only in the registered checkout (#1469).
 ...
 * wrap does.
 *
 * `test/wrap-step-config-root.test.js` fails when a step reads config any other way.
 *
