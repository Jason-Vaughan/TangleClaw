...
function _resumeRecord(previousResults) {
  ...
  const f = out.freshness || {};
  return {
    resume: {
      currentState: typeof out.currentState === 'string' ? out.currentState : null,
      nextAction: typeof out.nextAction === 'string' ? out.nextAction : null,
      freshness: {
        sha: typeof f.sha === 'string' ? f.sha : null,
        branch: typeof f.branch === 'string' ? f.branch : null,
        writtenAt: typeof f.writtenAt === 'string' ? f.writtenAt : null,
        tier: typeof f.tier === 'string' ? f.tier : null
      }
    },
    missing: null
  };
