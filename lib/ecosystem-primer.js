...
function workloadLine(format = 'md') {
  const text = 'Report your workload with `tc workload set <working|waiting-external|blocked|complete> '
    + '--clearance <safe-to-clear|do-not-clear|unknown> --summary "<one line>"` at dispatch acceptance, each task '
    + 'transition, the start of any external wait (`--wait ci|review|operator|peer|merge|other`), completion, before '
    + 'wrap and before exit, and again before it expires (30 min working, 120 min otherwise). Coordinators read it '
