...
function verdict(r) {
  ...
  if (r.mode !== 'control' && r.withOutput === 0) return { verdict: 'inconclusive', why: [...why, 'no client received terminal output'] };
  ...
  if (r.poolReturned === null || r.fdsReturned === null || r.lingering === null) short.push('resource return was not measured');
