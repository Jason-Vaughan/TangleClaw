...
function generateConfig(engineId, projectConfig, methodologyTemplate) {
  ...
  switch (generator) {
    ...
    case 'antigravity-md':
      return _generateGeminiMd(projectConfig, methodologyTemplate, '# .antigravity.md — Generated by TangleClaw');
    default:
 ...
 * @returns {string}
 */
function _generateGeminiMd(projectConfig, methodologyTemplate, header = '# GEMINI.md — Generated by TangleClaw') {
  const lines = [header, ''];
  const rules = _getRulesContent(projectConfig);
