...
function _generateClaudeMd(projectConfig, projectPath) {
  ...
  // Shared documents
  if (rules.sharedDocsContentShared || rules.sharedDocsContent) {
    // Committed carrier: the neutral rendering (#1619).
    lines.push(rules.sharedDocsContentShared || rules.sharedDocsContent, '');
  }
