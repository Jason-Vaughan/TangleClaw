 ...
 * The splice itself — and, crucially, what a malformed marker set means — lives
 * in `lib/managed-block.js`, shared with the wrap pipeline's priming roll so the
 * two cannot drift into different answers again. A malformed pair is REPAIRED
 * there, not refused: see that module for why, and for what repair may delete.
 *
