...
/**
 * Render a string as a single `/bin/sh` word.
 *
 ...
 * where TangleClaw is installed.
 *
 * @param {string} value - Raw value destined for a shell command line
...
function _resolveHookPlaceholders(str, dir) {
  ...
  return str.replace(/\{\{TANGLECLAW_DIR\}\}/g, () => _shellWord(tangleClawDir));
}
