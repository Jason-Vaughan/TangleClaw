...
function syncEngineHooks(projectPath, engineIdOverride) {
  ...
  // Only after the file exists is there anything to keep out of a commit, and
  // only a write can have created it.
  if (synced.written) _ensureLocalSettingsIgnored(projectPath, localFile);
