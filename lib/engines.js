...
function _getRulesContent(projectConfig) {
  ...
  return { coreRulesLines, extensionRulesLines, porthubGuide, sharedDocsGuide, sessionMemoryGuide, globalRules, sessionRulesLines, sharedDocsContent, serverPort, serverProtocol };
}
