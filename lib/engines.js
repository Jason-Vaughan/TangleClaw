 ...
 * @param {object} projectConfig - Per-project config
 * @returns {{ coreRulesLines: string[], extensionRulesLines: string[], porthubGuide: string|null, sharedDocsGuide: string|null, globalRules: string|null, sharedDocsContent: string|null, serverPort: number }}
 */
function _getRulesContent(projectConfig) {
  ...
  return { coreRulesLines, extensionRulesLines, porthubGuide, sharedDocsGuide, globalRules, sharedDocsContent, serverPort };
}
