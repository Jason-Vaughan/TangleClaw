...
function _buildSharedDocsSection(docs, options = {}) {
  ...
  const lines = committed
    ...
    'Send `groupId` to name the group you mean. Without it the list holds the documents of every group your project is in, never another project\'s. Lock before editing.', '']
    : ['## Shared Documents', ''];
