...
const { tcBootstrapLines, planDocsLine, contextReentryLine, controlStateLine } = require('./ecosystem-primer');
...
function _reportLegacyDuplicates(text, configFilePath, projectPath, syntax) {
  ...
  const preview = `node scripts/repair-governed-claude-md.js "${projectPath}"`;
  if (analysis.refused) {
