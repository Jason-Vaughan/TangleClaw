 ...
 *   error: string|null, errorCode: string|null, timedOut: boolean}>} `timedOut` distinguishes a command
 ...
 *   {@link execShell}.
 * @returns {Promise<{exitCode: number, stdout: string, stderr: string,
 *   error: string|null, errorCode: string|null, timedOut: boolean}>} Same contract as {@link execShell},
...
module.exports = { execShell, execFileArgs, NO_PROMPT_ENV, TIMEOUT_EXIT_CODE };
