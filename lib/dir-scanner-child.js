...
const HANDLERS = {
   ...
   *   config: object|null, unreadable?: string, code?: string}>} `unreadable` and
   *   `code` appear only on the refused branch — a directory that is there but
   *   which this server may not read.
   */
