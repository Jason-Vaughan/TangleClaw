...
// Derived once for the whole install (lib/tangleclaw-home.js). A PID file that
// lands somewhere other than where the store lives means the liveness check and
// the running server disagree about which install they are talking about.
const DEFAULT_DIR = tangleclawHome.baseDir();
