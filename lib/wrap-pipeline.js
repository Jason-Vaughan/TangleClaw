 ...
 *
 *   `async function run(context) -> {ok, status, output, blockers, deliveryOutcome?}`
 *   where `deliveryOutcome` is `'accepted'|'not-accepted'|'unknown'`, present only
 *   on a step that actually measured whether its prompt reached the engine (#1685).
 *
