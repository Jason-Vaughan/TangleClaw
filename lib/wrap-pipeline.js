 ...
 *
 * Opt-out: `projConfig.wrapV2` defaults `true` (flipped in #139 Chunk 11c /
 * #196). Only when a project explicitly pins it `false` does
 * `lib/sessions.js:triggerWrap` run the legacy NL-prompt path, byte-equal to
 * pre-#139 behavior.
 */
