 ...
 *   prove the nudge was accepted (`verify` answers `accepted`). No transport
 *   here has one yet; the wake monitor already records `wake_accepted` from
 *   one, and the Codex-native and Claude Stop-hook adapters are separate issues.
