...
// The cost, accepted: on a machine with no overlay name, one request per interval
// runs the probe synchronously on the request path, which can hold it for up to
// PROBE_TIMEOUT_MS if the CLI hangs. A missing binary fails at once.
