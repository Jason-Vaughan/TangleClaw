...
_Data as of 2026-09-26 18:40 UTC._ A snapshot, not a live feed — a published page cannot poll GitHub. Regenerate with `build-board.py`, then republish.
...
<details style="margin-bottom: 12px; border: 1px solid #30363d; border-radius: 6px; padding: 12px; background: #0d1117;">
<summary style="cursor:pointer; list-style:none;">
<div style="display:flex; flex-wrap:wrap; align-items:center; gap:4px; margin-top:4px; margin-bottom:4px;"><span style="font-size:1.2em; margin-right:4px;">🚂</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#411</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#575</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#880</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#401</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#626</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#708</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#709</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#711</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#752</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#788</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#806</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#825</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#857</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#909</span><span style="margin-left:12px; font-weight:bold; font-size:1.1em; color:#58a6ff;">Train 1: First Install, Completed</span><span style="margin-left:6px; color:#8b949e; font-size:0.9em;">(11/14)</span><span style="margin-left:6px; background:#1f6feb22; color:#58a6ff; border:1px solid #1f6feb; padding:2px 6px; border-radius:12px; font-size:0.75em;">verified</span></div>
</summary>
...
| [#788](https://github.com/Jason-Vaughan/TangleClaw/issues/788) | bug | ✅ closed | ~~The first step of the documented install fails on a clean Mac — git is a Command Line Tools stub~~ |
...
| [#825](https://github.com/Jason-Vaughan/TangleClaw/issues/825) | bug | ✅ closed | ~~A restarting server hides behind the unprotected screen — Continue fetches a dying process~~ |
| [#857](https://github.com/Jason-Vaughan/TangleClaw/issues/857) | bug | ✅ closed | ~~No ClawBridge version floor — a 1.9.x bridge now fails with a misleading "prompt must instruct the AI" message~~ |
...
<details style="margin-bottom: 12px; border: 1px solid #30363d; border-radius: 6px; padding: 12px; background: #0d1117;">
<summary style="cursor:pointer; list-style:none;">
<div style="display:flex; flex-wrap:wrap; align-items:center; gap:4px; margin-top:4px; margin-bottom:4px;"><span style="font-size:1.2em; margin-right:4px;">🚂</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#128</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1375</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1382</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1384</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1638</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1768</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#83</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#104</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#113</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#185</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#227</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#243</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#261</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#345</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#438</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#542</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#769</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#770</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#771</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#790</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#817</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#823</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#854</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#907</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1148</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1164</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1192</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1215</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1383</span><span style="margin-left:12px; font-weight:bold; font-size:1.1em; color:#58a6ff;">Train 2: The UI Says What It's Doing</span><span style="margin-left:6px; color:#8b949e; font-size:0.9em;">(23/29)</span><span style="margin-left:6px; background:#1f6feb22; color:#58a6ff; border:1px solid #1f6feb; padding:2px 6px; border-radius:12px; font-size:0.75em;">verified</span></div>
</summary>
...
| [#1638](https://github.com/Jason-Vaughan/TangleClaw/issues/1638) | feature | open | Add mobile on-screen modifier key bar (Esc, Ctrl, Tab, Arrows) to TTYD terminal UI |
| [#1768](https://github.com/Jason-Vaughan/TangleClaw/issues/1768) | enhancement | open | Show and undo a port lease's "Not a project" mark in the dashboard |
...
<details style="margin-bottom: 12px; border: 1px solid #30363d; border-radius: 6px; padding: 12px; background: #0d1117;">
<summary style="cursor:pointer; list-style:none;">
<div style="display:flex; flex-wrap:wrap; align-items:center; gap:4px; margin-top:4px; margin-bottom:4px;"><span style="font-size:1.2em; margin-right:4px;">🚂</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#801</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#934</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1025</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1084</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#342</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#372</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#556</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#783</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#784</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#785</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#791</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#792</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#810</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#812</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#818</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#820</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#836</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#837</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#868</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#904</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#912</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#945</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#998</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1020</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1023</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1075</span><span style="margin-left:12px; font-weight:bold; font-size:1.1em; color:#58a6ff;">Train 3: Session Switchboard</span><span style="margin-left:6px; color:#8b949e; font-size:0.9em;">(22/26)</span><span style="margin-left:6px; background:#1f6feb22; color:#58a6ff; border:1px solid #1f6feb; padding:2px 6px; border-radius:12px; font-size:0.75em;">verified</span></div>
</summary>
...
| [#810](https://github.com/Jason-Vaughan/TangleClaw/issues/810) | enhancement | ✅ closed | ~~Keep the steward session up — a managed always-on session class (Medusa reaps a wrapped consumer's identity)~~ |
...
<details style="margin-bottom: 12px; border: 1px solid #30363d; border-radius: 6px; padding: 12px; background: #0d1117;">
<summary style="cursor:pointer; list-style:none;">
<div style="display:flex; flex-wrap:wrap; align-items:center; gap:4px; margin-top:4px; margin-bottom:4px;"><span style="font-size:1.2em; margin-right:4px;">🚂</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#349</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#777</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#111</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#793</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#809</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#830</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#905</span><span style="margin-left:12px; font-weight:bold; font-size:1.1em; color:#58a6ff;">Train 4: Fleet Intelligence</span><span style="margin-left:6px; color:#8b949e; font-size:0.9em;">(5/7)</span><span style="margin-left:6px; background:#1f6feb22; color:#58a6ff; border:1px solid #1f6feb; padding:2px 6px; border-radius:12px; font-size:0.75em;">verified</span></div>
</summary>
...
| [#793](https://github.com/Jason-Vaughan/TangleClaw/issues/793) | feature | ✅ closed | ~~Tangle Code Review — autonomous PR review bot~~ |
| [#809](https://github.com/Jason-Vaughan/TangleClaw/issues/809) | enhancement | ✅ closed | ~~Own the trigger for prawduct governance telemetry — per-call log + one session report at wrap~~ |
| [#830](https://github.com/Jason-Vaughan/TangleClaw/issues/830) | feature | ✅ closed | ~~Warn a launching session when its plugin version moved, and flag running sessions that are stale~~ |
...
<details style="margin-bottom: 12px; border: 1px solid #30363d; border-radius: 6px; padding: 12px; background: #0d1117;">
<summary style="cursor:pointer; list-style:none;">
<div style="display:flex; flex-wrap:wrap; align-items:center; gap:4px; margin-top:4px; margin-bottom:4px;"><span style="font-size:1.2em; margin-right:4px;">🚂</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#660</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#670</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#721</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#747</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#748</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#772</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#808</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1196</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1205</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1377</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#177</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#213</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#362</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#429</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#797</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#802</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#831</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#835</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#840</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#843</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#844</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#847</span><span style="margin-left:12px; font-weight:bold; font-size:1.1em; color:#58a6ff;">Train 5: Release Readiness</span><span style="margin-left:6px; color:#8b949e; font-size:0.9em;">(12/22)</span><span style="margin-left:6px; background:#1f6feb22; color:#58a6ff; border:1px solid #1f6feb; padding:2px 6px; border-radius:12px; font-size:0.75em;">verified</span></div>
</summary>
...
| [#847](https://github.com/Jason-Vaughan/TangleClaw/issues/847) | bug | ✅ closed | ~~#839's false commit promise still ships in four more places — including the operator-facing remediation text~~ |
...
<details style="margin-bottom: 12px; border: 1px solid #30363d; border-radius: 6px; padding: 12px; background: #0d1117;">
<summary style="cursor:pointer; list-style:none;">
<div style="display:flex; flex-wrap:wrap; align-items:center; gap:4px; margin-top:4px; margin-bottom:4px;"><span style="font-size:1.2em; margin-right:4px;">🚂</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#2</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#239</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#277</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#533</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#811</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#794</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#833</span><span style="margin-left:12px; font-weight:bold; font-size:1.1em; color:#58a6ff;">Train 6: Public Parity</span><span style="margin-left:6px; color:#8b949e; font-size:0.9em;">(2/7)</span><span style="margin-left:6px; background:#1f6feb22; color:#58a6ff; border:1px solid #1f6feb; padding:2px 6px; border-radius:12px; font-size:0.75em;">verified</span></div>
</summary>
...
| [#794](https://github.com/Jason-Vaughan/TangleClaw/issues/794) | chore | ✅ closed | ~~GitHub sync on release — update docs, images, and metadata to match current state~~ |
...
<details style="margin-bottom: 12px; border: 1px solid #30363d; border-radius: 6px; padding: 12px; background: #0d1117;">
<summary style="cursor:pointer; list-style:none;">
<div style="display:flex; flex-wrap:wrap; align-items:center; gap:4px; margin-top:4px; margin-bottom:4px;"><span style="font-size:1.2em; margin-right:4px;">🚂</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#108</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#109</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#130</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#133</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#193</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#260</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#346</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#595</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#737</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#738</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#765</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#776</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#21262d; border:1px solid #30363d; color:#c9d1d9; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#1085</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#106</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#107</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#110</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#112</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#348</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#455</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#581</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#736</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#741</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#750</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#781</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#795</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#796</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#798</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#816</span><span style="color:#8b949e; font-size:0.8em;">━</span><span style="background:#238636; border:none; color:#ffffff; padding:2px 8px; border-radius:12px; font-size:0.85em; white-space:nowrap; font-family:monospace;">#858</span><span style="margin-left:12px; font-weight:bold; font-size:1.1em; color:#58a6ff;">Train 7: Engine Ecosystem</span><span style="margin-left:6px; color:#8b949e; font-size:0.9em;">(16/29)</span><span style="margin-left:6px; background:#1f6feb22; color:#58a6ff; border:1px solid #1f6feb; padding:2px 6px; border-radius:12px; font-size:0.75em;">verified</span></div>
</summary>
...
| [#781](https://github.com/Jason-Vaughan/TangleClaw/issues/781) | bug | ✅ closed | ~~Legacy vendored-hook cleanup isn't gated on the plugin being present, and the isPluginGoverned comment describes a deferral that doesn't exist~~ |
| [#795](https://github.com/Jason-Vaughan/TangleClaw/issues/795) | feature | ✅ closed | ~~Hermes system integration — review, design, and implement support~~ |
...
| [#777](https://github.com/Jason-Vaughan/TangleClaw/issues/777) | enhancement | open | Cross-project version dependency registry + notify dependents on release |
| [#781](https://github.com/Jason-Vaughan/TangleClaw/issues/781) | bug | ✅ closed | ~~Legacy vendored-hook cleanup isn't gated on the plugin being present, and the isPluginGoverned comment describes a deferral that doesn't exist~~ |
| [#786](https://github.com/Jason-Vaughan/TangleClaw/issues/786) | bug | ✅ closed | ~~A missing mkcert makes ingress-cutover throw a stack trace instead of a tagged refusal~~ |
| [#788](https://github.com/Jason-Vaughan/TangleClaw/issues/788) | bug | ✅ closed | ~~The first step of the documented install fails on a clean Mac — git is a Command Line Tools stub~~ |
| [#789](https://github.com/Jason-Vaughan/TangleClaw/issues/789) | bug | ✅ closed | ~~ingress-cutover --to direct always crashes after succeeding — pollHealth hardcodes https.get~~ |
| [#798](https://github.com/Jason-Vaughan/TangleClaw/issues/798) | feature | ✅ closed | ~~Guard the primary checkout while a chunk worktree exists — subagents and scripts default their cwd to the live install~~ |
