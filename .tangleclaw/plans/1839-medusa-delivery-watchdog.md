...
- [ ] Chunk 03, **reopened by the Architect's A3 ruling (`a06a43ac`); chunk 04 is on HOLD**. Built `2c65777d` with fixes `cd7424a8`; amendment (durable re-arm triggers) under review. Scope: wake transport seam, wake facts, and the watchdog timer (fake clock)
