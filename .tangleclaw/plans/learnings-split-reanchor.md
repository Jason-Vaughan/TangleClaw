...
status: IN PROGRESS 2026-09-23 — Chunk 01 built; Chunk 02 committed; PR held for Architect rulings D1–D7
...
| `shell-git.md` | 5, 11, 14, 28, 30, 54, 58, 62, 75, 90, 92, 117, 118, 127, 130, 131, 133 | ≈12.2 KB | code paths (D2) |
| `claims-review.md` | 3, 13, 21, 39, 40, 41, 53, 57, 77, 81, 83, 84, 87, 91, 98, 113, 115, 122, 123 | ≈14.9 KB | doc surfaces (D6) |
...
| `governance.md` | 19, 51, 61, 68, 69, 79, 93, 95, 100, 103, 108 | ≈5 KB | doc surfaces (D6) |
...
**Load effect.** This is what the split buys, stated honestly. A lib+test session loads about
68 KB instead of 115 KB. A `public/` UI session loads about 45 KB. A doc-only session loads about
20 KB and no testing rules. No single file is over budget, so the gate stops needing an override.
...
5. Verify: `prawduct-hook learnings-files --json` lists `core.md` plus the eleven files. Every file
