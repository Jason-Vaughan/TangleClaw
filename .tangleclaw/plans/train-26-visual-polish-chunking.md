...
`rev-20260917T123138Z-6120d2aa`, 0 blocking); its measurements and decisions are in
`.prawduct/artifacts/train-26-chunk-01-build-plan.md`. Two findings worth carrying: #1569 reproduces only from
